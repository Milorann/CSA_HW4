...
**Входные данные**  
Программа запускается с тремя вариантами аргументов коммандной строки: "n m output_file_name.txt", "input_file_name.txt output_file_name.txt" или "output_file_name.txt".  
...
Добавлены тесты 7 — 10 в папку Tests.  
Ввод данных из командной строки изменен.  
